...
object DepositumDisciplinaGeneraInstrumenti : DepositumNexuum<DisciplinaGeneraInstrumenti>() {
    override val nomenTabulae = NOMEN_TABULAE_DISCIPLINA_GENERA_INSTRUMENTI
    override val nomenColumnaeAlterumIdentitas = NOMEN_COLUMNAE_GENUS_INSTRUMENTI_IDENTITAS
    override fun crea(
