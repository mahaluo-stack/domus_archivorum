...
object RegistrumAngulus : Registrum<AngulusIdentitas, Angulus>() {
    ...
    override fun invenirePerClavemNecesse(identitas: AngulusIdentitas): Angulus = RegistraAngulus.invenirePerClavemNecesse(identitas)
    override fun invenireSiAdest(identitas: AngulusIdentitas): Angulus? = RegistraAngulus.invenireSiAdest(identitas)
}