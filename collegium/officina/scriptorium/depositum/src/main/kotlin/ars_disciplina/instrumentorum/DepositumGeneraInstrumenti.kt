...
import ars_disciplina.commune.constantia.ConstantiaNomenTabulae.NOMEN_TABULAE_GENUS_INSTRUMENTI
...
object DepositumGeneraInstrumenti : Depositum<GenusInstrumenti>() {
    ...
    override fun crea(rs: ResultSet): GenusInstrumenti {
        return GenusInstrumenti(
            GenusInstrumentiIdentitas(rs.getInt(NOMEN_COLUMNAE_GENUS_INSTRUMENTI_IDENTITAS)),
